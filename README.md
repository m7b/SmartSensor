...
----------|-------|---------|---------------|-------------------|
Master:   | [![example workflow](https://github.com/m7b/SmartSensor/actions/workflows/PlatformIO.yml/badge.svg)](https://github.com/m7b/SmartSensor/actions?query=workflow%3A"PlatformIO+CI") | [![Build status](https://ci.appveyor.com/api/projects/status/f4np60o1tfdux3ha?svg=true)](https://ci.appveyor.com/project/m7b/smartsensor) |   |
